...
3. `./bin/htsim_flow_app -tm ./apps/htsim/incast_8_1MB.cm -sender_cc_algo nscc -end 30000 -pcm_algorithm smartt &> smartt.log`
4. `python3 apps/htsim/htsim_pcm_cwnd_parser.py smartt.log smartt_cwnd.png`:
![](smartt_htsim.png)